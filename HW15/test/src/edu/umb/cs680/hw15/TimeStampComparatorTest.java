...
private String[] arraystringfordirectory(LinkedList<ApfsElement> fsElements) {
	...
	public static void setupupoffilestructure() {
		...
		ApfsDirectory applications = new ApfsDirectory(root, "applications", 0, localTime, "kedar", LocalDateTime.of(2020, 05, 12, 0, 0));
		ApfsDirectory home = new ApfsDirectory(root, "home", 0, localTime, "kedar", LocalDateTime.of(2020, 05, 21, 10, 0));
		ApfsDirectory code = new ApfsDirectory(home, "code", 0, localTime, "kedar", LocalDateTime.of(2020, 05, 21, 5, 0));
		ApfsFile a = new ApfsFile(applications, "a", 350, localTime, "kedar", LocalDateTime.of(2020, 05, 22, 10, 0));
		ApfsFile b = new ApfsFile(applications, "b", 700, localTime, "kedar", LocalDateTime.of(2020, 05, 23, 10, 0));
		ApfsFile c = new ApfsFile(home, "c", 800, localTime, "kedar", LocalDateTime.of(2020, 05, 22, 15, 0));
		ApfsFile d = new ApfsFile(home, "d", 80, localTime, "kedar", LocalDateTime.of(2020, 05, 23, 20, 0));
		ApfsFile apfselement = new ApfsFile(code, "apfselement", 700, localTime, "kedar", LocalDateTime.of(2020, 05, 22, 23, 0));
		ApfsFile f = new ApfsFile(code, "f", 870, localTime, "kedar", LocalDateTime.of(2020, 05, 23, 0, 20));
		ApfsLink x = new ApfsLink(home, "x", 0, localTime, "kedar", LocalDateTime.of(2020, 05, 24, 0, 15), applications);
		ApfsLink y = new ApfsLink(code, "y", 0, localTime, "kedar", LocalDateTime.of(2020, 05, 24, 0, 20), b);
	}
